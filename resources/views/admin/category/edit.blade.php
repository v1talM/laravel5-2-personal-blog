    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>{{ config('admin.category.category.edit') }}</h3>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text"
                                           ...
                                           name="name"
                                           value="{{ $category->name }}"
                                           placeholder="{{ config('admin.category.category.name') }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text"
                                           ...
                                           name="slug"
                                           value="{{ $category->slug }}"
                                           placeholder="{{ config('admin.category.category.slug') }}">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <textarea
                                            class="form-control"
                                            name="description"
                                            placeholder="{{ config('admin.category.category.description') }}">{{ $category->description }}</textarea>
                                </div>
                            </div>
                            <div class="ln_solid"></div>
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <a href="{{ route('admin.category.show') }}" class="btn btn-primary"><i class="fa fa-reply"></i> 返回</a>
