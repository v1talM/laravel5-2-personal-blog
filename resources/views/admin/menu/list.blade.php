...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('backend/vendors/jquery-nestable/jquery.nestable.css') }}">
@endsection
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" class="form-control" name="high_light" value="{{old('high_light')}}" placeholder="菜单高亮">
                                </div>
                            </div>
                            <div class="form-group">
...
@section('script')
    ...
    <script src="{{ asset('backend/build/js/menu-list.js')}}"></script>
